...
This revealed **9103** genes expressed in all samples (approximately 79% of all genes (n = 11557) expressed in the fat bodies).   
...
pdf(file = "results/upset_fat_body_plot.pdf",
    height = 12,
...
```{r, message = FALSE}
lintr::lint(file = "deseq2_analysis_fat_body_treatment.Rmd")
```