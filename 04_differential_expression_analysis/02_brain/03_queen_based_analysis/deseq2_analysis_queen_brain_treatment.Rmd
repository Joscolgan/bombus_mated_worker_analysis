...
This revealed **9320** genes expressed in all samples (approximately 83% of all genes (n = 11240) expressed in the brain).   
Second, density plots were generated for the percentage of expressed genes per sample for:
- Treatment (Fig. 2A)
- Stage (Fig. 2B)  
There was a significant difference  in terms of the mean percentage of expressed genes across castes (t-test; p = 0.04), but was a significant difference between treatments (ANOVA; p = 0.02) but not stage (ANOVA; p = 0.61).  
...
## Save:
dir.create(path = "results/brain_queen",
           recursive = TRUE)
write.table(x = counts_df,
            file = "results/brain_queen/qbrain_gene_level_counts.txt",
            row.names = TRUE,
            col.names = TRUE,
            quote = FALSE,
            sep = "\t")
...
pdf(file = "results/brain_queen/queen_upset_plot.pdf",
    height = 12,
...
## Save object:
saveRDS(object = vsd,
        file = "results/brain_queen/vsd_queen_brain_treatment.rds")
...
pdf(file = "results/brain_queen/brain_queen_filtered_pheatmap.pdf",
    height = 8,
    width = 8)
...
## Save to file:
ggsave(filename = "results/brain_queen/queen_brain_filtered_pca_plot.pdf",
       height = 8,
       width = 8)
```
...
write.table(x = deseq_object_results,
            file = "results/brain_queen/queen_brain_degs.txt",
            quote = FALSE,
            row.names = TRUE,
            col.names = TRUE,
            sep = "\t")
