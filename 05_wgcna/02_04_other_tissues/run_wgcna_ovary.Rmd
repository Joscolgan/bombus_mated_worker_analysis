...
transposed_gsg <- goodSamplesGenes(transposed_data,
                                   verbose = 3)
...
saveRDS(object = exp_sample_tree2,
        file = "results/exp_sample_tree2_ovary.rds")
saveRDS(object = exp_trait_colors,
        file = "results/exp_trait_colors_ovary.rds")
```
...
We now calculate the adjencies, using the soft thresholding power 12:
...
```{r, message = FALSE}
lintr::lint(file = "run_wgcna_ovary.Rmd")
```
