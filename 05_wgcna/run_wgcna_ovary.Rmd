---
author: "Joe Colgan"
title: "**Weight gene co-expression network analysis of ovaries of control and inseminated _Bombus terrestris_ workers and queens**"
output:
...
save(transposed_data_filt,
     samples_information,
     file = "results/ovary-01-dataInput.RData")
```
...
save(exp_geneModuleMembership,
     ...
     file = "results/ovary-04-input_for_membership_scatterplot_purple.RData")
```