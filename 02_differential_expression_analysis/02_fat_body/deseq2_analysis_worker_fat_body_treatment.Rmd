...
pdf(file = "results/worker_fat_body_upset_plot.pdf",
    height = 12,
...
## Save object:
saveRDS(object = vsd,
        file = "results/vsd_worker_fat_body_treatment.rds")
...
pdf(file = "results/worker_fat_body_filtered_pheatmap.pdf",
    height = 10,
    width = 10)
...
## Save to file:
ggsave(filename = "results/worker_fat_body_filtered_pca_plot.pdf",
       height = 8,
       width = 8)
```
...
write.table(x = deseq_object_results,
            file = "results/worker_fat_body_degs.txt",
            quote = FALSE,
            row.names = TRUE,
            col.names = TRUE,
            sep = "\t")
...
pdf(file = "results/worker_fat_body_filter_elevated_degs_venn_diagram_degs.pdf",
    height = 10,
    width = 10)
treatment_up_comparison_plot
dev.off()
...
pdf(file = "results/fat_body_worker/worker_fat_body_all_venn_diagram_degs.pdf",
    height = 6,
    width = 6)
...
## Write to file:
dir.create(path = "results/fat_body_worker/")
write(x = genes_of_interest,
      file = "results/fat_body_worker/inseminated_worker_elevated_gene_list.txt")
...
## Write to file:
ggsave(filename = "results/fat_body_worker/combined_heatmap_barchart.pdf",
       height = 6,
       width = 12,
       dpi = 600)
```
