...
saveRDS(object = deseq_object_results,
        file = "results/worker_deseq_object_results_treatment.rds")
...
pdf(file = "results/worker_brain_filter_reduced_degs_venn_diagram_degs.pdf",
    height = 10,
    width = 10)
treatment_comparison_plot
dev.off()
