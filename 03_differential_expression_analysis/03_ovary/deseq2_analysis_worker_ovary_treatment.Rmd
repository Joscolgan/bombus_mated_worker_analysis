...
## Samples:  
The worker 'Ovary' dataset consists:
...
## Save:
dir.create(path = "results/ovary_worker",
           recursive = TRUE)
write.table(x = counts_df,
            file = "results/ovary_worker/wovary_body_gene_level_counts.txt",
            row.names = TRUE,
            col.names = TRUE,
            quote = FALSE,
            sep = "\t")
...
pdf(file = "results/ovary_worker/worker_ovary_upset_plot.pdf",
    height = 12,
...
## Save object:
saveRDS(object = vsd,
        file = "results/ovary_worker/vsd_worker_ovary_treatment.rds")
...
pdf(file = "results/ovary_worker/worker_ovary_filtered_pheatmap.pdf",
    height = 10,
    width = 10)
...
## Save to file:
ggsave(filename = "results/ovary_worker/worker_ovary_filtered_pca_plot.pdf",
       height = 8,
       width = 8)
```
...
write.table(x = deseq_object_results,
            file = "results/ovary_worker/worker_ovary_degs.txt",
            quote = FALSE,
            row.names = TRUE,
            col.names = TRUE,
            sep = "\t")
...
pdf(file = "results/ovary_worker/worker_ovary_all_venn_diagram_degs.pdf",
    height = 6,
    width = 6)
treatment_comparison_plot
dev.off()

## Extract DEGs that are unique to the insemination group:
...
write(x = genes_of_interest,
      file = "results/ovary_worker/inseminated_worker_gene_list.txt")
...
dir <- "../2022_gene_ontology_analysis/results/bterrestris_dmel/output_50_inseminated_worker_ovary_fisher_weight01/"
## Load output:
...
## Write to file:
ggsave(filename = "results/ovary_worker/combined_heatmap_barchart.pdf",
       height = 6,
       width = 12,
       dpi = 600)
```
