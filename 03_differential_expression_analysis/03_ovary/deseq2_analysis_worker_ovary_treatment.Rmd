...
pdf(file = "results/worker_ovary_upset_plot.pdf",
    height = 12,
...
## Save object:
saveRDS(object = vsd,
        file = "results/vsd_worker_ovary_treatment.rds")
...
pdf(file = "results/worker_ovary_filtered_pheatmap.pdf",
    height = 10,
    width = 10)
...
## Save to file:
ggsave(filename = "results/worker_ovary_filtered_pca_plot.pdf",
       height = 8,
       width = 8)
```
...
write.table(x = deseq_object_results,
            file = "results/worker_ovary_degs.txt",
            quote = FALSE,
            row.names = TRUE,
            col.names = TRUE,
            sep = "\t")
...
write(x = genes_of_interest,
      file = "results/ovary_worker/inseminated_worker_elevated_gene_list.txt")
