...
This revealed **9210** genes expressed in all samples (approximately 83% of all genes (n = 11316) expressed in the ovary).   
...
pdf(file = "results/queen_ovary_upset_plot.pdf",
    height = 12,
...
pdf(file = "results/ovary_queen_filtered_pheatmap.pdf",
    height = 8,
    width = 8)
...
summary(pca)
```
No apparent outliers based on PCA, which is similar for other tissues:
...
## Save to file:
ggsave(filename = "results/queen_ovary_filtered_pca_plot.pdf",
       height = 8,
       width = 8)
```
...
write.table(x = deseq_object_results,
            file = "results/queen_ovary_degs.txt",
            quote = FALSE,
            row.names = TRUE,
            col.names = TRUE,
            sep = "\t")
