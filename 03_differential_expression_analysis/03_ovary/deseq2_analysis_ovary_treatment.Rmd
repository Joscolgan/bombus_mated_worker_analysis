...
## Introduction
The purpose of the present analysis is to examine similarities and differences in terms of gene expression associated with the ovary of _Bombus terrestris_ workers and queens. For the present study, control (unmated), and artificially inseminated bumblebees were collected and ovaries removed at three different time points (two, four and eight days post-treatment). The study also
...
This revealed **9103** genes expressed in all samples (approximately 79% of all genes (n = 11557) expressed in the ovaries).   
...
expression in the ovary of inseminated bees, which is significant deviation from equal outcome of expression profiles for differentially expressed genes (binomial test; *p* < 0.05).  
...
pdf(file = "results/ovary_filter_venn_diagram_degs.pdf",
    height = 10,
    width = 10)
