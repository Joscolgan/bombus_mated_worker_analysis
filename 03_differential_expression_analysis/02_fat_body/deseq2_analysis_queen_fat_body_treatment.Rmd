...
pdf(file = "results/queen_fat_body_upset_plot.pdf",
    height = 12,
...
## Save object:
saveRDS(object = vsd,
        file = "results/vsd_queen_brain_treatment.rds")
...
pdf(file = "results/brain_queen_filtered_pheatmap.pdf",
    height = 8,
    width = 8)
...
## Save to file:
ggsave(filename = "results/queen_brain_filtered_pca_plot.pdf",
       height = 8,
       width = 8)
```
