...
_p_ value and a minimum of absolute log2 fold change of 1, our model identifies **505** (Fig. 8)
...
saveRDS(object = worker_results_df,
        file = "results/deseq_object_results_worker_treatment.rds")
```
...
saveRDS(object = queen_results_df,
        file = "results/deseq_object_results_queen_treatment.rds")
```
