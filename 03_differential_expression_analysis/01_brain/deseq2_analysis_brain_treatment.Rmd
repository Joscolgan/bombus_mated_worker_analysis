...
samples_info$stage <- gsub(pattern = "_",
                                     replacement = " ",
                                     samples_info$stage)
```
...
pdf(file = "results/brain_filtered_pheatmap.pdf",
    height = 10,
    width = 10)
brain_heatmap_filtered <- pheatmap(sampleDistMatrix,
                                   clustering_distance_rows = sampleDists,
                                   clustering_distance_cols = sampleDists,
                                   col = colors)
dev.off()
...
## Save to file:
ggsave(filename = "results/brain_filtered_pca_plot.pdf",
       height = 8,
       width = 8)
```
...
pdf(file = "results/brain_filter_venn_diagram_degs.pdf",
    height = 10,
    width = 10)
